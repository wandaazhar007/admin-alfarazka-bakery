...
// import { fetchProducts, deleteProduct, type Product } from "../../services/productService";
...
//       `Yakin ingin menghapus produk "${name}"? Produk akan dinonaktifkan dari daftar.`
//     );
//     if (!ok) return;
...
//       // update list di client tanpa fetch ulang
